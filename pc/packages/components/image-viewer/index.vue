      ...
      >
        ...
        >
          ...
          <div :class="ns.e('canvas')">
            <template v-for="(v, i) in urlList" :key="i">
              <img
                v-if="i === activeIndex && v.type === 'image'"
              ...
              />
              <video
                v-else-if="i === activeIndex && v.type === 'video'"
...
import { EVENT_CODE, useLocale, useNamespace, useZIndex } from 'element-plus'
import { keysOf } from 'element-plus/es/utils/index.mjs'
...
import type { ImageViewerAction, ImageViewerMode } from './props'
...
const videoRefs = ref<HTMLAudioElement[]>([])
...
const currentImg = computed(() => props.urlList[activeIndex.value].url)
...
function handleVideoError(e: Event) {
  loading.value = true
  ;(e.target as HTMLImageElement).alt = t('el.video.error')
}
